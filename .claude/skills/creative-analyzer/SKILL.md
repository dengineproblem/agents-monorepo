...
2. **Multi-period анализ** - сравнение 7d vs 30d
3. **Топ/худшие креативы** - найти лучших и худших
4. **A/B тестирование** - настройка и анализ тестов
5. **Creative fatigue** - выявление выгорания
6. **Рекомендации** - что улучшить в креативах
