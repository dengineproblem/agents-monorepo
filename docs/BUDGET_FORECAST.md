...
- **Baseline**: что будет если ничего не менять
- **Scaling**: что будет при увеличении spend на +10%, +20%, +30%, +50%
...
1. **ForecastSummaryCard** - текущие метрики (spend, results, CPR, eligible ads)
2. **Сценарии** - табы: Без изменений / +10% / +20% / +30% / +50%
3. **ScenarioCard** - прогноз на неделю +1 и +2
