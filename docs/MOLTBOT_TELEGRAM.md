...
11. [Работа с инструментами (Tools)](#работа-с-инструментами-tools)
12. [Голосовые сообщения](#голосовые-сообщения)
13. [Лимиты затрат на AI](#лимиты-затрат-на-ai)
14. [Docker конфигурация](#docker-конфигурация)
15. [Мониторинг и логи](#мониторинг-и-логи)
16. [Troubleshooting](#troubleshooting)
17. [Команды управления](#команды-управления)
