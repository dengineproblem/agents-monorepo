-- =============================================
-- Миграция 176: Откат миграции 175, возвращаем purchase_date
-- Описание: purchase_date существует в таблице, миграция 175 была ошибочной
-- Дата: 2026-01-31
-- =============================================

-- 1. ПЕРЕСОЗДАНИЕ ИНДЕКСА С ПРАВИЛЬНЫМ ПОЛЕМ (purchase_date)
-- =============================================
...
-- 2. ПЕРЕСОЗДАНИЕ VIEW С ПРАВИЛЬНЫМ ПОЛЕМ (purchase_date)
-- =============================================
...
-- =============================================
-- ЗАВЕРШЕНИЕ МИГРАЦИИ 176
-- =============================================

DO $$
BEGIN
    RAISE NOTICE '============================================';
    RAISE NOTICE 'Миграция 176 успешно применена';
    RAISE NOTICE '============================================';
    RAISE NOTICE 'Откат миграции 175: возвращаем purchase_date';
    RAISE NOTICE 'Индекс: idx_purchases_consultant_date (purchase_date)';
    RAISE NOTICE 'View: consultant_sales_stats (purchase_date)';
    RAISE NOTICE '============================================';
END$$;
