...
=== БАЗОВЫЙ SCORE по этапу воронки (КАЖДЫЙ ЭТАП +5) ===
- new_lead: 5 баллов (базовый)
- not_qualified: 10 баллов (+5)
- qualified: 15 баллов (+5)
- consultation_booked: 20 баллов (+5)
- consultation_completed: 25 баллов (+5)
- deal_closed: 30 баллов (+5)
- deal_lost: 0 баллов
