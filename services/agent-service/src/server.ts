...
import supportEscalationsRoutes from './routes/supportEscalations.js';
...
import userCreativesRoutes from './routes/userCreatives.js';
...
app.register(userCreativesRoutes);
app.register(userPlansRoutes);
...
app.register(consultationsProxyRoutes);
...
app.register(supportEscalationsRoutes);
