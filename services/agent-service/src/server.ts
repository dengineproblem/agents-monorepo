...
import altegioAuthRoutes from './routes/altegioAuth.js';
import altegioWebhooksRoutes from './routes/altegioWebhooks.js';
import altegioApiRoutes from './routes/altegioApi.js';
...
app.register(altegioAuthRoutes);
app.register(altegioWebhooksRoutes);
app.register(altegioApiRoutes);
