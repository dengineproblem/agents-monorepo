...
export const tools: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        target_cpl_cents: { type: 'number', description: 'Целевой CPL в ЦЕНТАХ. $1 = 100. Примеры: $2 = 200, $5 = 500, $10 = 1000' },
      },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        bid_amount: { type: 'number', description: 'Ставка в ЦЕНТАХ (для BID_CAP и COST_CAP). $1 = 100' },
        dry_run: { type: 'boolean', description: 'Preview без применения' },
      },
      required: ['userAccountId', 'adset_id'],
    },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        userAccountId: { type: 'string' },
        campaign_id: { type: 'string', description: 'Facebook Campaign ID' },
        daily_budget: { type: 'number', description: 'Суточный бюджет в ЦЕНТАХ. $1 = 100. Примеры: $5 = 500, $10 = 1000' },
        lifetime_budget: { type: 'number', description: 'Бюджет за всё время в ЦЕНТАХ. $1 = 100' },
        dry_run: { type: 'boolean', description: 'Preview без применения' },
      },
      required: ['userAccountId', 'campaign_id'],
    },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        daily_budget_cents: { type: 'number', description: 'Суточный бюджет в ЦЕНТАХ. $1 = 100. Примеры: $5 = 500, $10 = 1000' },
        target_cpl_cents: { type: 'number', description: 'Целевой CPL в ЦЕНТАХ. $1 = 100. Примеры: $2 = 200, $5 = 500' },
  ...
  },
  {
    ...
    description: 'Получить информацию из базы знаний платформы. Без параметров — список глав. С chapter_id — оглавление. С chapter_id + section_id — содержимое. Используй когда пользователь спрашивает "как подключить", "как создать", "инструкция", "помощь".',
    input_schema: {
      type: 'object',
      properties: {
        userAccountId: { type: 'string' },
