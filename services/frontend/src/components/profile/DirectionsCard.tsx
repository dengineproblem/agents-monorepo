...
const DirectionsCard: React.FC<DirectionsCardProps> = ({ userAccountId, accountId }) => {
  ...
  const handleCreate = async (data: CreateDirectionFormData) => {
    ...
    const result = await createDirection({
      ...
      ...(data.whatsapp_connection_type && { whatsapp_connection_type: data.whatsapp_connection_type }),
      ...(data.whatsapp_waba_phone_id && { whatsapp_waba_phone_id: data.whatsapp_waba_phone_id }),
      ...(data.whatsapp_waba_access_token && { whatsapp_waba_access_token: data.whatsapp_waba_access_token }),
