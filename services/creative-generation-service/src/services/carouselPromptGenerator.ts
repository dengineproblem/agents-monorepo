...
FORM-FACTOR И SAFE-ZONE ДЛЯ INSTAGRAM КАРУСЕЛИ:

1) Холст:
   - формат для Instagram карусели 4:5, 1080×1350,
   - рекламная карточка карусели.

2) Safe-zone (безопасная зона для текста):
   - верхняя часть может быть частично занята интерфейсом (ник, аватар),
   - нижняя часть — подпись и элементы управления.

Твоя задача — разместить ВАЖНЫЙ ТЕКСТ в центральной безопасной области кадра:
   - избегать самого верха и самого низа для важных надписей,
...
НО:
   ...
   - фон и сцена должны выглядеть как единая цельная картинка на весь кадр.
...
1) Формат и назначение:
   - рекламный креатив для Instagram карусели, 4:5, 1080×1350;
...
- Не упоминать в видимом тексте формат, платформу, слова "карусель", "4:5", "safe zone" и т.п.
