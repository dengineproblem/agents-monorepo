...
export const VOLUME_THRESHOLDS = {
  ...
  MIN_LEADS: 3,           // Минимум лидов для расчёта QCPL
...
6. **Today-компенсация** (ВАЖНО!):
   - Если сегодня CPL в 2 раза лучше вчера → ПОЛНАЯ компенсация штрафов
...
- **СВОЙ целевой CPL** (direction_target_cpl_cents)
- Сумма бюджетов ad sets **НЕ ДОЛЖНА** превышать бюджет направления
- CPL оценивается относительно **direction_target_cpl_cents** (не глобального!)
...
**Today-компенсация:**
- Если impr_today ≥ 300 и eCPL_today значительно лучше eCPL_yesterday:
