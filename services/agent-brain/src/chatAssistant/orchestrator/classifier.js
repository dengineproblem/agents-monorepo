...
const DOMAIN_KEYWORDS = {
  ads: [
    'кампани', 'адсет', 'бюджет', 'расход', 'spend', 'cpl', 'ctr', 'cpm',
    'пауз', 'возобнов', 'реклам', 'campaign', 'facebook', 'instagram',
    'показ', 'клик', 'impressions', 'clicks', 'лид', 'конверс',
    'метрик', 'roi', 'roas', 'охват'
  ],
  whatsapp: [
...
ДОМЕНЫ:
- ads: Facebook/Instagram реклама (кампании, бюджеты, метрики, расходы, CPL, пауза/возобновление)
...
ПРАВИЛА:
1. Если запрос чётко относится к одному домену — выбери его
2. Если нужны данные из нескольких источников — выбери "mixed" и укажи нужные домены
3. Если непонятно — выбери наиболее вероятный домен

Ответь ТОЛЬКО валидным JSON:
{
  "domain": "ads" | "whatsapp" | "crm" | "mixed",
